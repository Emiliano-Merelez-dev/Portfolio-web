  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center md:items-start">
        <h1 className="text-4xl md:text-5xl font-extrabold fade-in mb-4 font-display">
          <Typewriter
            options={{
        ...
        <p className="text-lg md:text-xl max-w-xl mt-6 text-gray-300 fade-in font-sans">
          Full Stack Developer with a specialized focus on <span className="text-red-500">Front-end</span>, passionate about creating attractive and functional interfaces.
        </p>
        ...
        <div className="mt-10">
          <a
            href="#contacto"
            className="px-6 py-3 text-lg font-sans text-white bg-gradient-to-r from-cyan-500 to-blue-600 rounded-full shadow-md hover:shadow-blue-500/50 transition-all duration-300 hover:scale-105 hover:brightness-125"
          >
            ¡Contact me!
          </a>
        </div>
